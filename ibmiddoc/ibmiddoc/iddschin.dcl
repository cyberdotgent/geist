...
Classification:  Not classified
       ...
       Version:  4.3.5
          ...
          Name:  IBM Information Development Document SGML Declaration
                 for Codepage 01115 for use under OS/2.

          File:  IDDSCHIN.DCL

 Formal Public
   Identifiers:
                 +//ISBN 0-933186::IBM//TEXT IBMIDDoc SGML Declaration/Simplified Chinese SBCS IBM CP 01115/OS2//EN

      Function:  Markup declarations for the IBMIDDOC document type

Change History:   6 Nov 95  - Create declaration
                 13 Feb 95  - Added cgraphic characters below the x'20' line.
         ...
         Notes:
                 1) This SGML declaration represents IBM CP 01115
                    which is the single byte codepage for CCSID 1381.
