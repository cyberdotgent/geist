...
*Figure 4\-3\. IPCS Browse Option Entry Panel*
...
The IPCS Entry panel \([Figure 4\-3](4-3-3.md#FIGEPNL)\) is the first panel of the IPCS Browse option\. Using this panel with pointer and storage panels, the following tasks may be performed:
...
See ["Browsing a Dump Data Set" in topic 4\.5](4-5.md) for information on how to use the entry, pointer, and storage panels of the IPCS Browse option to view a dump\.
