...
[Figure 4\-21](4-5-2-2.md#FIGINA) repeats the same display as shown in [Figure 4\-18 in](3.png) [topic 4\.5\.2](3.png) except that an S \(a selection code\) has been entered in the pointer stack and the word HEADER has been entered for the address space\.
...
When you press Enter on the preceding pointer panel, IPCS displays the dump data on the storage panel, beginning with address 00000000 for the header record\. \(See [Figure 4\-22](4-5-2-2.md#FIGSTOPA)\.\) The dump header record provides you with diagnostic information such as:
...
```
   ...
   | HEADER STORAGE--------------------------------------------------------------     |
   | COMMAND ===> _                                               SCROLL ===> CSR     |
   | 00000000.   FEFF001D   40000000   C9D2D1C4   C1C9D940  | .... ...IKJDAIR  |      |
...
*Figure 4\-22\. Result of Selecting a Pointer on the Browse Option Pointer Panel*
