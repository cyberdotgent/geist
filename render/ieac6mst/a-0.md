...
`PROCESSOR (1) IS IN AN EXCESSIVE DISABLED SPIN LOOP WAITING FOR INTERSECT RELEASE REPLY U TO CONTINUE SPIN OR STOP PROCESSOR (2) AND REPLY ACR. (AFTER STOPPING THE PROCESSOR, DO NOT START IT)`
...
1\. Access IPCS and the full\-screen dialog by doing the steps outlined in ["Accessing the IPCS Dialog" in topic 4\.2](4-2.md)\.
...
b\. Display the section of the report entitled "Branch\-Entry Messages on the Delayed Issue Queue" by entering:
