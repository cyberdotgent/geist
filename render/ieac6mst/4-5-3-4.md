...
Primary commands can be entered on the command line of the storage panel\. See [Figure 4\-13 in topic 4\.4\.2](4-4-2.md#P2) for the primary commands and PF keys that you can enter on this panel\.
...
2\. If you issue the IPCS primary command with a subcommand that modifies X, the storage displayed will be updated to reflect the location of the modified X\. For example, the storage of the IEFBR14 module is displayed if you enter the following on the storage panel:

`ipcs findmod iefbr14`

[Figure 4\-28](4-5-3-4.md#FIGDB0) shows the use of the special symbol CURSOR, in conjunction with the % selection code, on the STACK and LOCATE primary commands\. The figure was shown after selecting the third pointer in the pointer stack on the pointer panel for address space 8 \(see [Figure 4\-26 in topic 4\.5\.3\.2](4-5-3-2.md#FIGSTAE)\)\. On the command line, the two primary commands are entered, separated by a semicolon\.
...
```
   ...
   |                                                                                  |
   | ASID(X'0008') STORAGE ------------------------------------------------------     |
   | COMMAND ===> stack cursor%;locate cursor%_                    SCROLL ===> CSR    |
   | 00000DB0.   01937D80   00FB6EF0   0194E7F8   00937E20    | .l'...>0.mX8.l=. |    |
   ...
   | 0000DF20.   2FB00060   000009CF   B0000000   0A00008C    | ...-...........ð |    |
...
[Figure 4\-29](4-5-3-4.md#FIGSTPNL3) and [Figure 4\-30](4-5-3-4.md#FIGSTAEA) show the results of processing the two primary commands\. [Figure 4\-29](4-5-3-4.md#FIGSTPNL3) illustrates how the locate command scrolled to the requested address of storage \(00000000\)\. [Figure 4\-30](4-5-3-4.md#FIGSTAEA) shows that an additional pointer is added to the pointer stack \(00008\), with address 00000000 for address space 8\.
...
*Figure 4\-29\. Result of Processing the LOCATE Primary Command on the Browse Option Storage Panel*
...
*Figure 4\-30\. Result of Processing the STACK Primary Command on the Browse Option Pointer Panel*
