...
<a id="FIGFIGUNIQ156"></a>

```
                            _____________ 
                           ↓             |
     →→_____LISTDS______(_____data-set___|__)___ __________ __ ___________ __ ___________ ____→
                                                |__STATUS__|  |__HISTORY__|  |__MEMBERS__|

     →_ _______ __ _________________________ __ _________ ___→←
       |_LABEL_|  |__CATALOG(catalog-name)__|  |__LEVEL__|
```
...
`HISTORY` specifies that you want to obtain the creation and expiration dates for the specified data sets and find out whether the non\-VSAM data sets are password\-protected or if the data set is RACF protected\.
