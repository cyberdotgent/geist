...
The operating system, the OS/400* program, provides the tools you will use to run the AS/400 system. It allows you to run multiple jobs regardless of any other programs running at the same time.
