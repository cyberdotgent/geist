...
| `Specifi`e`d me`n`u selecti`o`n` i`s n`o`t correc`t. | If you forget to type an option number and then press the Enter key, the | computer reminds you to do this with the message: | `Ty`p`e opti`o`n numbe`r.
