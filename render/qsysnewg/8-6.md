...
default printer. | One list you might want a printed copy of is the list of AS/400 | publications mentioned i [n "Information Displays" in topic 5](5-4.md).4. | Follow these steps carefully. Consider the official AS/400 publications | list your diploma. 1. Turn on your display and sign on ( [Chapter 2, "Signing On and Signing](2-0.md) Off [Your Computer"). |](2-0.md) 2. From the AS/400 Operational Assistant menu, select option 75 | (Documentation and problem handling) (Ch [apter 5, "Using Displays").](5-0.md)| 3. From the Documentation and Problem Handling menu, select option 2 | (AS/400 publications). | 4. You should be at the top (first display) of the publications list. | Now, press your Print key (Ch [apter 3, "Your Keyboard"),](3-0.md) and you get a | message at the bottom of your screen (Ch [apter 7, "Messages"):](7-0.md)(
