...
| the job you were working on when you temporarily signed off will be | ended as if you had signed off directly from the application, or from | the AS/400 Main Menu (using option 90). | To temporarily sign off the AS/400 system from a display you are working on, simply press the Attn key (see [Appendix E, "AS/400 Keyboards," to](e-0.md) [determine which key](e-0.md) is your Attn key). At this point, you should be | looking at the AS/400 Operational Assistant menu.
