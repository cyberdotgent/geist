...
***Error*** ***Reset*** ***Key*** | display when you played with your keyboard i [n Chapter 2, "Signing On a](2-0.md) nd [| Signing Off Your Computer](2-0.md)." | You use the Ctrl key as the Error Reset key on personal computer | keyboards.
...
On some keyboards, the Page Up and the Page Down keys are down on the display.
