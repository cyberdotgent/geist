...
***Error*** ***Reset*** ***Key*** display when you played with your keyboard in [Chapter 2, "Signing On and](2-0.md) [Signing Off Your Computer."](2-0.md)| You use the Ctrl key as the Error Reset key on personal computer | keyboards.
