...
Menu displays Entry displays List displays Information displays Although the four kinds of displays look and act differently, they have three things in common: 1. They have **titles**. 2. They list their **active** **function** **keys**. 3. They explain their **purpose**., c.cp
...
| You can use this shortened name, o**r me**n**u** ID, to get to a particular menu quickly. We explain more about this in [Appendix B, "Advanced Menu](b-0.md) [Planning.")](b-0.md) The active function keys are listed on the bottom of the display: | F1=Help | F3=Exit | F9=Command Line | F12=Cancel
