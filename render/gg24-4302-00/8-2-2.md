...
IMS 4\.1 also introduced **dynamic pool management** whereby many buffer pools grow and contract as required, so avoiding the need to stop IMS just to increase a pool size\. The DBRC PRILOG record used to grow ever larger as an IMS system archived more and more logs\. Again in IMS 4\.1, a dynamic **PRILOG compression** facility was introduced\.
