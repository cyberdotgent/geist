...
The remote procedure call allows applications to access procedures on a network as if they were local subroutines\. IMS supports the Open Software Foundation's Distributed Computing Environment \(OSF/DCE\) RPC model, in cooperation with MVS OpenEdition and OpenEdition Application Server/IMS \(AS/IMS\)\.
