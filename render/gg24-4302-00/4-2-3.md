...
Some database START commands can take an inconveniently long time to process\. For example: `/START DATABASE ALL /START DATAGROUP(grpname)`
...
`/START DATABASE name1,name2,name3,..... NODBALLOC /START DATABASE ALL NODBALLOC /START DATAGROUP(grpname) NODBALLOC`
