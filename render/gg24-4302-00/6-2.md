...
The implementation of POSIX support within MVS is shown in [Figure 4 in](4.png) [topic 2\.4\.2](4.png)\. More information can be found in the following MVS documentation:
