...
This section illustrates the concepts introduced in the preceding sections, by showing the steps involved for normal tracking and for the case when tracking is interrupted for some reason\. [Figure 21](10.png) shows the system components\.
