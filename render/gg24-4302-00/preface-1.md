...
- [Chapter 1, "Introducing IMS/ESA Version 5 Release 1"](1-0.md)
...
- [Chapter 2, "IMS Version 5\.1 Overview"](2-0.md)

An overview of the technical features of IMS 5\.1 is presented\.

- [Chapter 3, "IMS 5\.1 Processing Cost Enhancements"](3-0.md)
...
- [Chapter 4, "IMS 5\.1 Operating Cost Enhancements"](4-0.md)

The IMS 5\.1 features affecting the operational costs of IMS are described\.

- [Chapter 5, "IMS 5\.1 Availability and Remote Site Recovery"](5-0.md)
...
- [Chapter 6, "IMS 5\.1 Distributed Processing and Open Access"](6-0.md)
...
- [Chapter 7, "IMS 5\.1 Miscellaneous Enhancements"](7-0.md)

Various small \(but important\) enhancements to IMS are described\.

- [Chapter 8, "The IMS/ESA 5\.1 System"](8-0.md)
...
- [Chapter 9, "Migration to IMS 5\.1"](9-0.md)
