...
- Traditional applications using IMS DL/1 calls to access messages \(**implicit** mode\)
...
\(10\) MVS provides two APPC implementations, the CPI\-C interface, which is common to many platforms, and an MVS\-specific interface where all verbs are of the form "ATB\.\.\.\.\.\." An IMS application can use either interface\.
