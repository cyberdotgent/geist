...
In IMS 5\.1, the Program Routing Exit is called in new circumstances and has a larger ranger of routing options\. It is called for an alternate PCB CHNG call when the following conditions apply:
...
**R0 Meaning Positive** SYSID of originating system if CHNG call on remote system **Negative** SYSID when processing system is the originating system

The routing function is determined by setting the return code in register 15\. The possible values and their meanings are shown in [Table 10](<#TBLCMPRR15>)\.
...
```
   ...
   |____________|_________________________________________________________________________________________________________|
   |     04     | Route message back to originating system, using the destination LTERM set by the CHNG call              |
   |____________|_________________________________________________________________________________________________________|
   |     08     | Reject CHNG call (A1 status)                                                                            |
   |____________|_________________________________________________________________________________________________________|
   |     0C     | Route message back to originating system, using the destination transaction set by the CHNG call        |
   |____________|_________________________________________________________________________________________________________|
   |     10     | Route the message to a specified MSC system and use the LTERM specified in the CHNG call                |
   |            |                                                                                                         |
   |            | The target system is defined by use of registers 1 and 2:                                               |
   |            |                                                                                                         |
   |            | °   Routing by SYSID                                                                                    |
   |            |                                                                                                         |
   |            |     Register  Contents                                                                                  |
   ...
   |____________|_________________________________________________________________________________________________________|
   |     14     | Route the message to a specified MSC system and use the transaction specified in the CHNG call          |
   |            |                                                                                                         |
   |            | The target system is defined by use of registers 1 and 2:                                               |
   |            |                                                                                                         |
   |            | °   Routing by SYSID                                                                                    |
