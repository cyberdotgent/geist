...
It is very important for IMS to support all three of these programming models. IMS 4.1 fully supports the conversational model using the LU6.2 protocol through VTAM and APPC/MVS. In IMS 5.1, OTMA provides the facility for IMS to communicate very efficiently with MVS applications other than VTAM, such as TCP/IP for MVS, Application Server/IMS, and MQSeries for MVS. Refer to ["The Open IMS Server" in topic 8.5](8-5.md) for more information about this open world.
