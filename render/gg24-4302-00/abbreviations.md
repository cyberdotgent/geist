...
***ASIC*** Asynchronous Image Copy

***BBO*** Batch Backout

***BLDS*** Block Level Data Sharing

***BMP*** Batch Message Driven Program
...
***CPIC \(or CPI\-C\)*** Common Programming Interface for Communications

***CUSN*** CI Update Sequence Number

***CSOM*** Client Server Object Manager
...
***DDEP*** Direct Dependent \(Segment\)

***DEDB*** Data Entry Data Base

***DLT*** Database Level Tracking

***DOVF*** Dependent Overflow Section
...
***HPTS*** Highly Parallel Transaction System

***HSSP*** High Speed Sequential Processing

***IBM*** International Business Machines Corporation

***IFP*** IMS Fastpath Program \(or Interactive Fastpath Program\)

***ILS*** Isolated Log Sender

***IMS*** Information Management System

***IOVF*** Independent Overflow Part
...
***MID*** Message Input Discriptor

***MOD*** Message Output Discriptor
...
***MSC*** Multiple Systems Coupling Facility
...
***NMD\-BMP*** Non\-message Driven BMP
...
***PCB*** Program Communications Block
...
***Pseudo\-WFI*** Pseudo Wait for Input

***RACF*** Resource Access Control Facility

***RAP*** Root Anchor Point

Root Adressable Part

***RBA*** Relative Byte Address

***RECON*** Recovery Control \(data set\)

***RLT*** Recovery Level Tracking

***RPC*** Remote Procedure Call

***RSR*** Remote Site Recovery

***SDEP*** Sequential Dependent \(Segment\)

***SG*** Service Group

***SLDS*** System Log Data Set

***SLUP*** Secondary Logical Unit \- Programmable

***SMB*** Scheduler Management Block
...
***TMS*** Transport Manager Subsystem
