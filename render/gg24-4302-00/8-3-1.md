...
IMS 4\.1 saw the introduction of RACF security for IMS commands\. IMS 5\.1 introduces RACF security for the new type of automated operator programs\. SMU works typically at the terminal level and is still available in some environments\. But facilities like ETO are incompatible with SMU, and a move to user based security is recommended\.
