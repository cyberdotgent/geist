[Previous](preface-4-3-2.md) | [Index](README.md) | [Next](changes.md)

---

## PREFACE.4.4 Message Directory

<a id="HDRMSGPRE"></a>

To use a message prefix to locate the book containing a specific message, see the following table.
...
| BLG | Information System, Information Management | Information/System Version 2 Messages and<br>Codes | SC34-2106 |
| BLM | Information System, Information Management | Information/System Version 2 Messages and<br>Codes | SC34-2106 |
| BLS | Interactive problem control system (IPCS) | MVS/ESA Dump Output Messages | GC28-1662 |
| BLX | Information System, Information Management | Information/System Version 2 Messages and<br>Codes | SC34-2106 |
| BNH | Network Problem Determination Application<br>(NPDA) | Network Problem Determination Application:<br>Messages and Codes | SC34-2012 |
| BQI | 3790 Communication System | IBM 3790 Communication System Messages | GA27-2789 |
| CBP | MVS configuration program (MVSCP) | MVS/ESA System Messages | GC28-1656 |
| CBR | Object access method (OAM) | MVS/ESA System Messages | GC28-1656 |
| CHS | MVSSERV messages for the user and system<br>programmer | TSO/E Version 2 Messages | GC28-1885 |
| COF | Virtual lookaside facility (VLF) | MVS/ESA System Messages<br>MVS/ESA Dump Output Messages<br>TSO/E Version 2 Messages | GC28-1656<br>GC28-1662<br>GC28-1885 |
| CSV | Contents supervision, virtual fetch, fetch | MVS/ESA System Messages<br>MVS/ESA Dump Output Messages | GC28-1656<br>GC28-1662 |
| DFH | Customer Information Control System/Virtual<br>Storage (CICS/VS) | CICS/VS Messages and Codes | SC33-0081 |
...
| ICQA | Information Center Facility administrator<br>messages | TSO/E Version 2 Messages | GC28-1885 |
| ICQC | Information Center Facility user messages | TSO/E Version 2 Messages | GC28-1885 |
...
| IFA | System management facilities (SMF) | MVS/ESA System Messages<br>MVS/ESA Dump Output Messages | GC28-1658<br>GC28-1662 |
| IFB | Input/output environment recording<br>routines: OBR and SVC 76 | MVS/ESA System Messages | GC28-1658 |
| IFC | IFCDIP00 service aid for SYS1.LOGREC | MVS/ESA System Messages | GC28-1658 |
...
| IGF | Dynamic device reconfiguration (DDR)<br>Machine check handler (MCH) | MVS/ESA System Messages | GC28-1658 |
| IGY | VS COBOL II | VS COBOL II Application Programming Guide | SC26-4045 |
| IGZ | VS COBOL II | VS COBOL II Application Programming:<br>Debugging | SC26-4049 |
| IHJ | Data Facility Product (DFP) checkpoint<br>Scheduler restart | MVS/ESA System Messages | GC28-1658 |
| IKJ | Time Sharing Option Extensions (TSO/E) | TSO/E Version 2 Messages<br>MVS/ESA System Messages<br>MVS/ESA Dump Output Messages | GC28-1885<br>GC28-1658<br>GC28-1662 |
| IKF | VS COBOL II | VS COBOL II Application Programming:<br>Debugging | SC26-4049 |
...
| IRD | ESCON Director Device Support (EDDS) | System Messages | GC28-1658 |
| IRX | Time Sharing Option Extensions (TSO/E)<br>restructured extended executor language<br>(REXX) | TSO/E Version 2 Messages | GC28-1885 |
| ISG | Global resource serialization | MVS/ESA System Messages<br>MVS/ESA Dump Output Messages | GC28-1658<br>GC28-1662 |
| IST | Advanced Communications Function for<br>Virtual Telecommunications Access Method<br>(ACF/VTAM) | Advanced Communications Function for VTAM<br>Messages and Codes | SC27-0614<br>SC27-0470<br>SC23-0114 |
| ITA | TOLTEP for Advanced Communications Function<br>for Virtual Telecommunications Access<br>Method (ACF/VTAM) | Advanced Communications Function for VTAM<br>Messages and Codes | SC27-0614<br>SC27-0470<br>SC23-0114 |
| ITT | Component trace | MVS/ESA System Messages | GC28-1658 |
