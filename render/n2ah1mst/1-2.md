...
```text
   ...
   -    information, such as a time stamp.  The following topic shows the format
   of the message.  Then the topics show the information accompanying the a    message on the MCS console and on the hard-copy log in a JES2 system and a
   JES3 system.
```
