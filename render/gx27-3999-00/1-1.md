...
The universally administered address label shows the adapter's universally administered addresses for each port\. These are the medium access control \(MAC\) addresses that were encoded in the adapter memory at the factory\.
