...
Before you run TPNS using your complete network definition and all of the
...
The number and type of sample tests you run depend on how large your simulated network is and how complicated your message generation scripts are\. As you become more experienced with using TPNS for a particular type of simulation, you may need to run fewer sample tests\. Initially, however, you should plan to conduct a number of sample tests to help you detect and correct errors\.
