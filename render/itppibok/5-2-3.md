...
configuration for the example TPNS test is shown in [Figure 4](3.png). In this figure, the resources that are simulated by TPNS are shown within the labelled dashed line.
