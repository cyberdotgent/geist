...
There is an important consideration to be had here: it is possible to have *an imp*li*cit n*etmask based on the range that the host address falls into. This table shows the class, range, and implicit netmask:
...
| Class | Range |
| --- | --- |
| A | 0.0.0.0 -<br>127.255.255.255 |
| B | 128.0.0.0 -<br>191.255.255.255 |
| C | 192.0.0.0 |
