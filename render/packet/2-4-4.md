...
There is an important consideration to be had here: it is possible to have an *implicit netmask* based on the range that the host address falls into\. This table shows the class, range, and implicit netmask:
