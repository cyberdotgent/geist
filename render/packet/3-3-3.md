...
(21) "NAT" used here is a colloquial term for what Cisco IOS calls NAT **Ov**er**load, s**ome network engineers call PAT **(Po**rt Address Translation), and Windows calls "Internet Connection Sharing." There is some debate as to which term is the true one, but most people just call it "NAT.".
