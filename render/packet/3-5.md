...
The program that controls this tunnel is ax25ipd, and it has two operating modes (IP and UDP, as mentioned before). The configuration file is located _ at /etc/ax25/ax25ipd.conf -- start with a sample like this ***for*** AX/IP mode:
