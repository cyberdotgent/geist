...
(33) Note that the example shown here assumes that your edge router knows that it can access the 192.168.48.0/24 network through your Linux's machine; in reality, you may struggle to do this or have to resort to setting up NAT. If this is the case, see the earlier NAT example under the Linux AX.*25 ex*am*ple..*
