...
After you have defined all of those ports, you now need to start them. In this day and age, most Linux distributions do not automatically load the Linux kernel modules for packet radio, so load them yourself: [(16)](#FTNFTNUNIQ25)
...
future section), enable it with this command:
