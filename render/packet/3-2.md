...
- callsign: the unique callsign and SSID used for the port [(13)](#FTNFTNUNIQ22)
- speed: the baud rate used on the interface's serial link [(14)](#FTNFTNUNIQ23)
...
- name: the port name
- callsign: the unique NET/ROM callsign for this port [(15)](#FTNFTNUNIQ24)
