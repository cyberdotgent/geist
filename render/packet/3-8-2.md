...
at /usr/local/share/doc/direwolf/conf/direwolf.conf (unless you did not install Dire Wolf from the source code). Ensure the configuration file contains the following elements:
