...
- **`DOMAIN.SYS`:** A BIND\-compatible [\(53\)](<#FTNFTNUNIQ67>) DNS zone file that maps hostnames to IP addresses
...
- **`XROUTER.SYS`:** Contains commands to run at startup [\(54\)](<#FTNFTNUNIQ68>)
