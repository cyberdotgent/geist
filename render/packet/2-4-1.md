...
Note that zeros are omitted from this IPv6 addressing scheme \-\- an address that has entire words of zeros can be abbreviated\. Take the following example IPv6 address:
