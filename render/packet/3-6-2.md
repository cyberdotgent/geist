...
commands to make the node do something useful. The command syntax consists of the following elements:
...
/etc/services by convention, but you can also replace "node" in the first word of the line with a port number to achieve the same effect..
