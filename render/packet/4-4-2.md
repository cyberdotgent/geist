...
If your user account has been keyed into ftpusers and you are marked as an *advanced* *user*, you will be able to see a more complex shell prompt, but also possibly enter sysop mode to break into a JNOS shell and run any command. With advanced mode on, your shell prompt changes to this:
