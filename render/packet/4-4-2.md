...
If your user account has been keyed into ftpusers and you are marked as an *advanced* *user*, you will be able to see a more complex shell prompt, but also possibly enter sysop mode to break into a JNOS
...
-- Making NET/ROM connections is fairly easy, but mak**ing AX.2**5-NoL3 connections will require you to be aware of the port. You can use the p command:
...
In this mode, it can be rather difficult to determine which port is present on which frequency/interface; as such, *sysops*
