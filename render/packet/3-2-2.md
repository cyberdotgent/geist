...
By the time you have completed the above commands, you should have several interfaces added to the output of the ifconfig command; invoke it and see for yourself: [(17)](#FTNFTNUNIQ26)
