...
NCP protocol had yet to be replaced, Hank scored a very valuable victory: *) the en*tirety of the 44.0.0.0/8 network was allocated for amateur radio, and became known as AMPRnet. <a id="fnref-FTNFTNUNIQ3"></a>[(3)](#FTNFTNUNIQ3)

* Two years later (in January 1983), NCP was replaced with TCP, and RFC 790 listed it amongst several other networks. <a id="fnref-FTNFTNUNIQ4"></a>[(4)](#FTNFTNUNIQ4)
