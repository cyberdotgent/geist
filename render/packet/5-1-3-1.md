...
- entered earlier. With QtTermTCP open, go to Setup -> Hosts -> New Host. The options are as follows:
...
" real-estate; to do that, right-click and select "Set Monitor/Output Split."
