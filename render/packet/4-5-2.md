...
SLIP is **Serial Line IP**, and is a simplistic way of framing IP packets on a serial cable \(either synchronous or asynchronous\)\. If you need to get JNOS to talk to an embedded device, SLIP might be ideal\!
