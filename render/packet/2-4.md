...
standard; you probably used IP to get this document!
...
- ICMP (Internet Control Message Protocol), used to allow network hosts to test communication (this is the ping command), detect adjacent
