...
******up****** to two di***g***ip***eaters. *A**** digip*eater is a* *p**ac*ket *repeat*er s*y*stem,**
...
***a***ddress numbers (***wh***ich ru***n*** 0 to 7 so 4 bits; N(R) andN(S) fit nicely in one byte together)

- PID (Protocol ID): this specifies the protocol contained within the

0x01: ISO 8208 (X.25 Packet Layer Protocol) [(6)](#FTNFTNUNIQ8) 0x06: VJ-compressed TCP/IP [(7)](#FTNFTNUNIQ9)
...
an **T*h*e** "n*o l*ay*er*-3" **A*X.25* *operating* mode is **us*ed* for *co*nn*e*ctio*ns fr*om a** *packet* *terminal* *to* *a* *BBS* *or* *packet* *radio* *command-line* *shell* *node.*
