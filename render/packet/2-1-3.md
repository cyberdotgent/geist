...
up t***o ***tw***o ***di***gip***ea***ters. A dig***ipe*a*te*r is a pac*ke*t *r*e*p*eater *s*ystem,*

/ usua*lly sim*p*lex; you* *can* *onl*y* hav*e* two* *dig*i*peaters alo*n*g a p*a*t*h*!*
...
address numbers (which ***r***u***n ***0*** ***to 7 so 4 bits; N(R) andN(S) fit nicely in one byte together)
...
an *The* "*n**o *la*yer-3" **A*X.*25 op*er*ating mod*e *is u*se*d *f*or c*o*nne*c*tions from *a *packet* *terminal* *to* *a* *BBS* *or* *packet* *radio* *command-line* *shell* *node.*
