...
- ( 2. All nodes on both networks need to be made aware that they can route to the other network, and told how to get ther

Examine the following diagram of the setu
...
First, you must engage IP forwarding (routing) on the packet node:
...
! Likewise, you need to provide PC 2 with a routing table entry. This
