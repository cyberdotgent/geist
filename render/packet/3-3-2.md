...
If you have two networks, say `192.168.1.0/24` and`192.168.44.0/24` \(the packet radio "LAN" used in the above example\)\. If we wish to route between these two networks, two things need to happen:
