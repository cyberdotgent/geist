...
Set the callsign used for APRS's I-gate client: [(40)](#FTNFTNUNIQ53)

```text
aprs logon call WA4XYZ-3
```

When you log into the APRS-IS system, you need to specify a **filter** (or you [FTNFTNUNIQ54](#FTNFTNUNIQ54) will get no APRS traffic at all): (41)
...
I will not provide an overtly-detailed explanation for this as it is somewhat out of the scope for this document, but the B between 08723.75W and WA4XYZ-3 is the **symbol** **selector** and the / between 3561.22N and [FTNFTNUNIQ55](#FTNFTNUNIQ55) 08723.75W is the **table** **selector.** (42)
...
(41) See the section earlier o**n A**P**RS Filt**ers to understand these!.
