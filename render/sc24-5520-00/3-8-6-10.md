...
After issuing a SENDDATA, you cannot issue another SEND [\(18\)](<#FTNSENDFN2>), RECEIVE, or SEVER TYPE=NORMAL on that path until the outstanding SENDDATA is complete\.
...
- When RECEIVE=NO, FLUSH=YES, and you specify a 0\-length send buffer \(this is called a **pure flush**\), your SENDDATA completes immediately, unless your partner is notified of the flush\. \(See topic [3\.8\.3\.6](3-8-3-6.md) for more information\.\)
...
\(18\) SEND generally refers to all of the APPC/VM send functions: SENDCNF, SENDCNFD, SENDDATA, SENDERR, and SENDREQ\.
