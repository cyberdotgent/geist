...
Because the SENDREQ function completes immediately, you can issue another SEND [\(20\)](<#FTNSRQFN>) or RECEIVE on the path when your virtual machine regains control\.
...
\(20\) In this case, SEND refers to the set of APPC/VM send functions: SENDCNF, SENDCNFD, SENDDATA, SENDERR, and SENDREQ\.
