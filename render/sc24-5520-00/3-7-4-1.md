...
- **Program Initialization Parameters \(PIP data\)**, which can serve many purposes\. \(See ["Specifying a PIP Variable" in topic 3\.8\.1\.7](3-8-1-7.md) for more information\.\)

After examining this data, your communications partner can do either of the following in response to your connect request:
