...
To ensure that you get all of the extended information, declare your extended interrupt buffer using the maximum possible size\. Use the IUCV QUERY,PRMLIST= function to determine the maximum size of the buffer\. \(See ["IUCV QUERY" in topic 5\.10\.8](5-10-8.md) for more information\.\)
...
\(24\) Connection pending and connection complete interrupts on APPC/VM paths\.
