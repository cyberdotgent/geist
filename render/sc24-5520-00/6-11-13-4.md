...
**Flags** is a set of bits defining the type of signal sent\. Only three bits are defined and the others are unused\. The defined bits are:

**Code Meaning X'80'** Signal\-In **X'40'** Signal\-Out **X'10'** Broadcast signal **X'2F'** Unused

**Signal ID** is the source's signal ID\.
