...
You cannot issue another RECEIVE, SEND [\(15\)](<#FTNRECVFN>), or SEVER TYPE=NORMAL on the same path until your outstanding RECEIVE completes\. Your RECEIVE completes immediately when it is issued for the following:
...
- If your communication partner severs, your RECEIVE completes immediately\. The IPWHATRC value in your output parameter list indicates the sever, and you are presented with a sever interrupt\.

<a id="FTNRECVFN"></a>

\(15\) In this case, SEND refers to the set of APPC/VM send functions: SENDCNF, SENDCNFD, SENDDATA, SENDERR, and SENDREQ\.
