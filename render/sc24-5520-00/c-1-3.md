...
[Figure 81](2.png) illustrates the details of the control records\. The control record includes:

An updated version of the message pending external interrupt buffer, received as a result of an IUCV SEND\. This area, mapped by the IPARML control block, contains:

- IPRMMSG1\-\-the displacement to the first byte of the control area\. IPRMMSG1 is a fullword containing the offset from the start of this 4KB control record to the start of the control area\.
- IPRMMSG2\-\-the displacement to the last byte of the control area\. IPRMMSG2 is a fullword containing the offset from the start of this 4KB control record to the last byte of the control area\.
