[Previous](appendix1-1-1-17.md) | [Index](README.md) | [Next](appendix1-1-1-19.md)
...
****int**** argc Argument count ****char** *a**rgv[] ++ Arguments with the `program` n`ame are in` argv[0]; argv[argc] is always `NULL`.
