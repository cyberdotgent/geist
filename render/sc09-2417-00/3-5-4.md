...
A locale definition source member contains information about a language environment\. This information is divided into a number of distinct categories which are described in ["Categories Used in a Locale" in](3-5-5.md) [topic 3\.5\.5](3-5-5.md)\. One locale definition source member characterizes one language environment\.
