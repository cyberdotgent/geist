...
The display file `T2123DDF` is the same DDS source as that described in ["Change the Default Program Device" in topic 3\.3\.1\.7](3-3-1-7.md)\.
...
The output is the same as in the program output for ["Change the Default](3-3-1-7.md) [Program Device" in topic 3\.3\.1\.7](3-3-1-7.md)\.
