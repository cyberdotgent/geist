...
C\+\+ provides a linkage specification to enable procedure calls and the sharing of data between the C\+\+ caller and the called procedure\. See ["Calling a Program Using a Linkage Specification" in topic 4\.1\.2](4-1-2.md) for the syntax\.
