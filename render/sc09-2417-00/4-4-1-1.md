...
[ This code shows `how e`x`tern` "OS" with a function definition is used to replace the #pragma linkage directive. See [Chapter 12, "Calling](4-1.md) [Conventions" in topic 4.1](4-1.md) for additional information. Instead of using
