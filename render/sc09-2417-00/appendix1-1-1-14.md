...
- The set of signals for the `signal()` function and the parameters and usage of each signal are described in [Chapter 14, "Handling](4-3.md) [Exceptions" in topic 4\.3](4-3.md) and in the *C Library Reference* under `signal`\.
