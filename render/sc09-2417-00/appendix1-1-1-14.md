...
- The set of signals for the `signal()` function and the parameters and usage of each signal are described in [Chapter 14, "Handling](4-3.md) [HDRHEXCP](4-3.md) [ Exceptions" in topic 4.3 and in the C Library Referen`ce und`er signal.
