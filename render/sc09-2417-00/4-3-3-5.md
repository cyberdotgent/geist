...
| --- | --- | --- |
| Library routines | exit<br>_EXIT_VERB | _EXIT_VERB<br>normal termination, invocations<br>canceled by this function are<br>normal.<br>is abnormal termination,<br>invocations canceled by this |
...
| AS/400 commands | Process | _ABNORMAL_TERM |
| RCLACTGRP | _ABNORMAL_TERM _RCLRSC | The default is abnormal<br>termination. The termination<br>can be normal if a<br>normal/abnormal flag is added<br>to the command. |
