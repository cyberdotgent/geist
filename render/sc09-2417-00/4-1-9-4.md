...
The source code for program `T2123CL3` is identical to the source code shown < [in "CL Program T2123CL2" in topic 4.](#HDRTCL2) 1.8.4. C++ Source File T2123ICB.CPP

The source for the ILE C++ program `T2123ICB` is almost identical to the source shown in ["C++ Source File T2123IC5" in topic 4.1.8.4](#HDRTIC5). The difference lies in the linkage specifications used for interlanguage calls:
...
[ To enter data for the pro`gram T21`23ICB enter the AS/400 comm`and: T21`23CM2 and press F4 (Prompt). You can enter the sample data in ["Invoking the](4-1-8-5.md) [[ ILE-OPM Program" in topic 4.](4-1-8-5.md) 1.8.5.

The output is the same as for the OPM version of this program.

The physical file `T2123DD2` contains the same data as shown in the OPM version in ["Invoking the ILE-OPM Program" in topic 4.1.8.5](4-1-8-5.md).
