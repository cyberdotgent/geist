...
See ["Externally Described File T2123DD2" in topic 4\.1\.8\.4](4-1-8-4.md) for the DDS source of the audit file `T2123DD2`\.
...
The source code for program `T2123CL3` is identical to the source code shown in ["CL Program T2123CL2" in topic 4\.1\.8\.4](4-1-8-4.md)\.

#### **C\+\+ Source File T2123ICB\.CPP**

The source for the ILE C\+\+ program `T2123ICB` is almost identical to the source shown in ["C\+\+ Source File T2123IC5" in topic 4\.1\.8\.4](4-1-8-4.md)\. The difference lies in the linkage specifications used for interlanguage calls:
...
To enter data for the program `T2123ICB` enter the AS/400 command: `T2123CM2` and press F4 \(Prompt\)\. You can enter the sample data in ["Invoking the](4-1-8-5.md) [ILE\-OPM Program" in topic 4\.1\.8\.5](4-1-8-5.md)\.
