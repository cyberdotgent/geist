...
The global variable `_EXCP_MSGID` is set whenever a stream or record I/O function gets an exception\. The global variable `_EXCP_MSGID`, declared in the `<stddef.h>` header file, contains the exception message ID\. See [Table 28 in topic 4\.3\.6\.5](<#TBLREXCP>) for information about the `_EXCP_MSGID` setting after an OS/400 exception\.
