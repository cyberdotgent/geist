...
After you create the program `grpag` with a user\-named activation group, the program is activated and `main()` is called\. If you run the program again, the following results:
