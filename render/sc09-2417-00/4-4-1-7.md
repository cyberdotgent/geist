...
cast expression. You can also use the /J+ compiler option when you compile */ the C++ source to set the de`faul`t char type. See the C++ User's Guide for more information on these options.
