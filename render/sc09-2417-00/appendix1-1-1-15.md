...
- [ A diagnostic message is ident`ified` a`s msg_id` `seve`rity text where `[` msg_id consists of 7 characters. The first three characters are upper case letters and the last 4 characters are decimal digits.
