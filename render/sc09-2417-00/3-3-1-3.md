...
To open an AS/400 display file, ICF file, or printer file as a binary stream file for record\-at\-a\-time processing use the `fopen()` function with a mode of, `wb`, and `ab`, and optional keyword parameters *type*, and *indicators*\.
