...
To access a C++ class from a C program you need to write your own functions to inspect and manipulate the class data members directly. **<** Note: While data members in the C++ c**lass c**an **be publi**c, protected, or private**, the v**ariables in the corresponding C structure are always publicly accessible. Be careful, you may eliminate the safeguards built into the C++ language.
