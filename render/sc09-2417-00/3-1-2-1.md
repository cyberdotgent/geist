...
- Record format name
- Record format level ID (level-checking information) The following #pragma mapinc and #include directives

```text
can      #pragma mapinc("custmf","MYLIB/CUSTMSTL(CUSREC)","both key","d")
#include "custmf"
```
