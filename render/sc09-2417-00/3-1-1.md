...
Externally described files are files that have their field descriptions

as part of the file. The file description includes information [ about the type of file (such as data or device), record formats, and a description of each field and its attributes.
