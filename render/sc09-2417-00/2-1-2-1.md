...
The default stream I/O for programs compiled with ILE C is simulated on top of an AS/400 database file. This is simulated stream file processing & with AS/400 records [. Figure](10.png) 10 shows how an AS/400 record is mapped to a C stream.
