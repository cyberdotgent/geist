...
On the integrated file system, a stream is a continuous string of characters. A database file is record-oriented; it has predefined subdivisions consisting of one or more fields that have specific characteristics, such as length and data type. [Figure 9](9.png) compares a stream

file and a record-oriented database file.
...
The default stream I/O for programs compiled with ILE C is simulated on top of an AS/400 database file. This is simulated stream file processing & with AS/400 reco [rds. Figu](10.png) re 10 shows how an AS/400 record is mapped to a C stream.
