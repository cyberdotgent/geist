...
The C++ language provides templates and several keywords not found in the < C language. Other features inc*lude try-catch-*throw exception handling, stricter type checking and more versatile access to data and functions compared to the C language.
