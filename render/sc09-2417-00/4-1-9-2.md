...
- < An ILE `program` T2123ICB in w`hich t`he main() function of a C++ module `T2123ICB` calls a procedure `CalcAndFormat` in an ILE COBOL module `T2123CB2`
...
- An externally described file T212`3DD2 tha`t receives the audit trail, data
