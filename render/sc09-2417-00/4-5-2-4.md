...
| Operand | typeid Returns<br>represents it.<br>represents the type of the expression.<br>type | type_name<br>expression<br>Reference to a polymorphic<br>referred to. |
| --- | --- | --- |
| Pointer to a polymorphic | The dynamic type of the complete object |  |
| pointed to. If the pointer is zero, the |  | typeid expression throws bad_typeid |
| exception. | Nonpolymorphic type<br>type of the expression. The expression is | The type_info that represents |
...
<< The class type_info is describ [ed in "The type_info Cla](4-5-2-5.md) ss" in [topic 4.5.2.5](4-5-2-5.md).
