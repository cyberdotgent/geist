...
[ To control the format of `the sc`anf() function use the * and width fields of the `scanf()` function. See the C Library Reference for information on these fields. [TBLFLAG](#TBLFLAG) Print Function Flags: Table 29 describes the flag characters and their meanings for `D(n,p)` conversions.
