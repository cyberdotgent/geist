...
Each HLL has its own way of passing parameters. Parameters can be passed as a pointer to the parameter value, to a copy of the value, or [ to the value itself. C++ passes parameters in all three ways. See ++ ["Using Default Parameter Passing Styles" in topic 4](4-1-4-2.md).1.4.2 for information on these styles.
