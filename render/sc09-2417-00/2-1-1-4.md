...
All users working with objects in QDLS must be enrolled in the system distribution directory. Path Names
...
Each component of the path name can consist of just a name `/QDLS/FLR1/DOC1`

or a name plus an extension /QDLS/FLR1/DOC1.TXT.
